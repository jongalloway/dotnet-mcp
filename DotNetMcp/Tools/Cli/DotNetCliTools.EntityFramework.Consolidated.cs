...
public sealed partial class DotNetCliTools
{
    ...
    [McpServerTool(IconSource = "https://raw.githubusercontent.com/microsoft/fluentui-emoji/62ecdc0d7ca5c6df32148c169556bc8d3782fca4/assets/Floppy%20Disk/Flat/floppy_disk_flat.svg")]
    [McpMeta("category", "ef")]
    ...
    internal async Task<string> DotnetEfMigrationsAdd(
        string name,
        string? project = null,
        string? startupProject = null,
        string? context = null,
    ...
    internal async Task<string> DotnetEfMigrationsList(
        string? project = null,
        string? startupProject = null,
        string? context = null,
        string? framework = null,
    ...
    internal async Task<string> DotnetEfMigrationsRemove(
        string? project = null,
        string? startupProject = null,
        string? context = null,
        string? framework = null,
    ...
    internal async Task<string> DotnetEfMigrationsScript(
        string? from = null,
        string? to = null,
        string? output = null,
        string? project = null,
    ...
    internal async Task<string> DotnetEfDatabaseUpdate(
        string? migration = null,
        string? project = null,
        string? startupProject = null,
        string? context = null,
    ...
    internal async Task<string> DotnetEfDatabaseDrop(
        string? project = null,
        string? startupProject = null,
        string? context = null,
        string? framework = null,
    ...
    internal async Task<string> DotnetEfDbContextList(
        string? project = null,
        string? startupProject = null,
        string? framework = null,
        bool noBuild = false,
    ...
    internal async Task<string> DotnetEfDbContextInfo(
        string? project = null,
        string? startupProject = null,
        string? context = null,
        string? framework = null,
    ...
    internal async Task<string> DotnetEfDbContextScaffold(
        string connection,
        string provider,
        string? project = null,
        string? startupProject = null,
